...
func startGameScript(gp *GamePanel, path string, player *Player, data map[string]string, game_key mrgnet.GameKey) {
	...
	LuaPushSmartFunctionTable(gp.script.L, "Script", FunctionTable{
		"ChooserFromFile":                   func() { gp.script.L.PushGoClosure(chooserFromFile(gp)) },
		"StartScript":                       func() { gp.script.L.PushGoClosure(startScript(gp, player)) },
		"GameOnRound":                       func() { gp.script.L.PushGoClosure(doGameOnRound(gp)) },
		"SaveGameState":                     func() { gp.script.L.PushGoClosure(saveGameState(gp)) },
		"LoadGameState":                     func() { gp.script.L.PushGoClosure(loadGameState(gp)) },
		"DoExec":                            func() { gp.script.L.PushGoClosure(doExec(gp)) },
		"SelectEnt":                         func() { gp.script.L.PushGoClosure(selectEnt(gp)) },
		"FocusPos":                          func() { gp.script.L.PushGoClosure(focusPos(gp)) },
		"FocusZoom":                         func() { gp.script.L.PushGoClosure(focusZoom(gp)) },
		"SelectHouse":                       func() { gp.script.L.PushGoClosure(selectHouse(gp)) },
		"LoadHouse":                         func() { gp.script.L.PushGoClosure(loadHouse(gp)) },
		"SaveStore":                         func() { gp.script.L.PushGoClosure(saveStore(gp, player)) },
		"ShowMainBar":                       func() { gp.script.L.PushGoClosure(showMainBar(gp, player)) },
		"SpawnEntityAtPosition":             func() { gp.script.L.PushGoClosure(spawnEntityAtPosition(gp)) },
		"GetSpawnPointsMatching":            func() { gp.script.L.PushGoClosure(getSpawnPointsMatching(gp)) },
		"SpawnEntitySomewhereInSpawnPoints": func() { gp.script.L.PushGoClosure(spawnEntitySomewhereInSpawnPoints(gp)) },
		"IsSpawnPointInLos":                 func() { gp.script.L.PushGoClosure(isSpawnPointInLos(gp)) },
		"PlaceEntities":                     func() { gp.script.L.PushGoClosure(placeEntities(gp)) },
		"RoomAtPos":                         func() { gp.script.L.PushGoClosure(roomAtPos(gp)) },
		"SetLosMode":                        func() { gp.script.L.PushGoClosure(setLosMode(gp)) },
		"GetAllEnts":                        func() { gp.script.L.PushGoClosure(getAllEnts(gp)) },
		"DialogBox":                         func() { gp.script.L.PushGoClosure(dialogBox(gp)) },
		"PickFromN":                         func() { gp.script.L.PushGoClosure(pickFromN(gp)) },
		"SetGear":                           func() { gp.script.L.PushGoClosure(setGear(gp)) },
		"BindAi":                            func() { gp.script.L.PushGoClosure(bindAi(gp)) },
		"SetVisibility":                     func() { gp.script.L.PushGoClosure(setVisibility(gp)) },
		"EndPlayerInteraction":              func() { gp.script.L.PushGoClosure(endPlayerInteraction(gp)) },
		"GetLos":                            func() { gp.script.L.PushGoClosure(getLos(gp)) },
		"SetVisibleSpawnPoints":             func() { gp.script.L.PushGoClosure(setVisibleSpawnPoints(gp)) },
		"SetCondition":                      func() { gp.script.L.PushGoClosure(setCondition(gp)) },
		"SetPosition":                       func() { gp.script.L.PushGoClosure(setPosition(gp)) },
		"SetHp":                             func() { gp.script.L.PushGoClosure(setHp(gp)) },
		"SetAp":                             func() { gp.script.L.PushGoClosure(setAp(gp)) },
		"RemoveEnt":                         func() { gp.script.L.PushGoClosure(removeEnt(gp)) },
		"PlayAnimations":                    func() { gp.script.L.PushGoClosure(playAnimations(gp)) },
		"PlayMusic":                         func() { gp.script.L.PushGoClosure(playMusic(gp)) },
		"StopMusic":                         func() { gp.script.L.PushGoClosure(stopMusic(gp)) },
		"SetMusicParam":                     func() { gp.script.L.PushGoClosure(setMusicParam(gp)) },
		"PlaySound":                         func() { gp.script.L.PushGoClosure(playSound(gp)) },
		"SetWaypoint":                       func() { gp.script.L.PushGoClosure(setWaypoint(gp)) },
		"RemoveWaypoint":                    func() { gp.script.L.PushGoClosure(removeWaypoint(gp)) },
		"Rand":                              func() { gp.script.L.PushGoClosure(randFunc(gp)) },
		"Sleep":                             func() { gp.script.L.PushGoClosure(sleepFunc(gp)) },
		"EndGame":                           func() { gp.script.L.PushGoClosure(endGameFunc(gp)) },
	})
	...
	LuaPushSmartFunctionTable(gp.script.L, "Net", FunctionTable{
		...
		"Side":                func() { gp.script.L.PushGoClosure(netSideFunc(gp)) },
		"UpdateState":         func() { gp.script.L.PushGoClosure(updateStateFunc(gp)) },
		"UpdateExecs":         func() { gp.script.L.PushGoClosure(updateExecsFunc(gp)) },
		"Wait":                func() { gp.script.L.PushGoClosure(netWaitFunc(gp)) },
		"LatestStateAndExecs": func() { gp.script.L.PushGoClosure(netLatestStateAndExecsFunc(gp)) },
	})
	//gp.script.L.SetMetaTable(-2)
